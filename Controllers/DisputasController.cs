...
namespace RpgMvc.Controllers
{
    ...
    {
        public string uriBase = "http://gabsimoes28.somee.com/RpgApi/Disputas/";
        ...
        public async Task<ActionResult> IndexHabilidadesAsync()
        {
            try
            {
                ...
                if (response.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    List<HabilidadeViewModel> listaPersonagens = await Task.Run(() =>
                ...
                string uriBuscaHabilidades = "http://gabsimoes28.somee.com/RpgApi/PersonagemHabilidades/GetHabilidades";
